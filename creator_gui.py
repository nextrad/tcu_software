...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_clk_period = QtWidgets.QLabel(self.groupBox_2)
        self.label_clk_period.setObjectName("label_clk_period")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.label_clk_period)
        ...
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.spin_clk_period)
        self.label_pri_pulse_width = QtWidgets.QLabel(self.groupBox_2)
        self.label_pri_pulse_width.setObjectName("label_pri_pulse_width")
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.label_pri_pulse_width)
        ...
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.spin_pri_pulse_width)
        self.label_prepulse = QtWidgets.QLabel(self.groupBox_2)
        self.label_prepulse.setObjectName("label_prepulse")
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.label_prepulse)
        ...
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.spin_prepulse)
        self.label_x_amp_delay = QtWidgets.QLabel(self.groupBox_2)
        self.label_x_amp_delay.setObjectName("label_x_amp_delay")
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.label_x_amp_delay)
        ...
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.spin_x_amp_delay)
        self.label_l_amp_delay = QtWidgets.QLabel(self.groupBox_2)
        self.label_l_amp_delay.setObjectName("label_l_amp_delay")
        self.formLayout_2.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.label_l_amp_delay)
        ...
        self.formLayout_2.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.spin_l_amp_delay)
        self.label_rex_delay = QtWidgets.QLabel(self.groupBox_2)
        self.label_rex_delay.setObjectName("label_rex_delay")
        self.formLayout_2.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.label_rex_delay)
        ...
        self.formLayout_2.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.spin_rex_delay)
        self.label_dac_delay = QtWidgets.QLabel(self.groupBox_2)
        self.label_dac_delay.setObjectName("label_dac_delay")
        self.formLayout_2.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.label_dac_delay)
        ...
        self.formLayout_2.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.spin_dac_delay)
        self.label_adc_delay = QtWidgets.QLabel(self.groupBox_2)
        self.label_adc_delay.setObjectName("label_adc_delay")
        self.formLayout_2.setWidget(12, QtWidgets.QFormLayout.LabelRole, self.label_adc_delay)
        ...
        self.formLayout_2.setWidget(12, QtWidgets.QFormLayout.FieldRole, self.spin_adc_delay)
        self.button_more_params = QtWidgets.QPushButton(self.groupBox_2)
        self.button_more_params.setObjectName("button_more_params")
        self.formLayout_2.setWidget(15, QtWidgets.QFormLayout.SpanningRole, self.button_more_params)
        self.label_num_repeats = QtWidgets.QLabel(self.groupBox_2)
        self.label_num_repeats.setObjectName("label_num_repeats")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_num_repeats)
        ...
        self.label_waveform_index = QtWidgets.QLabel(self.groupBox_2)
        self.label_waveform_index.setObjectName("label_waveform_index")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_waveform_index)
        ...
        self.combo_waveform_index.addItem("")
        self.combo_waveform_index.addItem("")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.combo_waveform_index)
        self.label_samples_per_pri = QtWidgets.QLabel(self.groupBox_2)
        self.label_samples_per_pri.setObjectName("label_samples_per_pri")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_samples_per_pri)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.spin_samples_per_pri)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_clk_period.setText(_translate("MainWindow", "Clock Period [ns]"))
        self.label_pri_pulse_width.setText(_translate("MainWindow", "Trig width [μs]"))
        self.label_prepulse.setText(_translate("MainWindow", "Prepulse  [μs]"))
        self.label_x_amp_delay.setText(_translate("MainWindow", "X amp delay [μs]"))
        self.label_l_amp_delay.setText(_translate("MainWindow", "L amp delay [μs]"))
        self.label_rex_delay.setText(_translate("MainWindow", "REX delay [μs]"))
        self.label_dac_delay.setText(_translate("MainWindow", "DAC Delay"))
        self.label_adc_delay.setText(_translate("MainWindow", "ADC Delay"))
        self.button_more_params.setText(_translate("MainWindow", "Show More"))
        self.label_num_repeats.setText(_translate("MainWindow", "Number of repeats"))
        self.label_waveform_index.setText(_translate("MainWindow", "Waveform Index"))
        ...
        self.label_samples_per_pri.setText(_translate("MainWindow", "Samples / PRI"))
        ...
        self.combo_mode.setToolTip(_translate("MainWindow", "<html><head/><body><p>Polarization Mode</p><p><br/><span style=\" font-style:italic;\">mode num</span>: <span style=\" font-style:italic;\">freq. band </span>[<span style=\" font-style:italic;\">t</span><span style=\" font-style:italic;\">x pol</span> - <span style=\" font-style:italic;\">rx pol</span>]</p></body></html>"))
        self.combo_mode.setItemText(0, _translate("MainWindow", "0: L [V-V]"))
        self.combo_mode.setItemText(1, _translate("MainWindow", "1: L [V-H]"))
        self.combo_mode.setItemText(2, _translate("MainWindow", "2: L [H-V]"))
        self.combo_mode.setItemText(3, _translate("MainWindow", "3: L [H-H]"))
        self.combo_mode.setItemText(4, _translate("MainWindow", "4: X [V-H/V]"))
        self.combo_mode.setItemText(5, _translate("MainWindow", "5: X [H-H/V]"))
